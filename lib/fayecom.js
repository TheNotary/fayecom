...
// get app root...
var appRootConfirmed;

var firstTry = appRoot;
if (IsThere(firstTry + '/test/fixtures/keys/key.pem'))
  appRootConfirmed = firstTry;


var secondTry = path.resolve(appRoot + "/..");
if (IsThere(secondTry + '/test/fixtures/keys/key.pem'))
  appRootConfirmed = secondTry;
  
var thirdTry = appRoot.path + "/node_modules/fayecom";
if (IsThere(thirdTry + '/test/fixtures/keys/key.pem'))
  appRootConfirmed = thirdTry;

if (appRootConfirmed == undefined)
  endThisCharade();
else
  appRoot = appRootConfirmed;
